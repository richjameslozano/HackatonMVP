...
- [ ] 1. Extend types, config, and utility foundations
  - [ ] 1.1 Add new types and extend existing interfaces in `src/types/index.ts`
  ...
  - [ ] 1.2 Extend `src/services/config.ts` with new table IDs
    - Add `coinConfig` and `projects` entries to `TABLE_IDS`
    - _Requirements: 8.1, 8.2_

  - [ ] 1.3 Add validation functions to `src/utils/validation.ts`
  ...
  - [ ] 1.4 Add formatting utilities in `src/utils/formatting.ts`
  ...
  - [ ] 1.5 Add admin permission check in `src/utils/permissions.ts`
    - Implement `isAdmin(member)` — returns true if member has admin role
    - _Requirements: 4.4, 4.5_

  - [ ] 1.6 Add project ID serialization helpers in `src/utils/project-ids.ts`
...
- [ ] 2. Implement coin and project services
  ...
  - [ ] 2.2 Create `src/services/project.service.ts`
  ...
  - [ ] 2.3 Extend `src/services/quest.service.ts` for coin integration
  ...
  - [ ]* 2.4 Write property tests for coin service
  ...
  - [ ]* 2.5 Write property test for completion record coins
    - **Property 4: Completion record includes correct coins_awarded**
    - **Validates: Requirements 2.3**

  - [ ]* 2.6 Write property tests for project service
...
- [ ] 4. Implement coin store and extend app store
  - [ ] 4.1 Create `src/store/coin.store.ts`
  ...
  - [ ] 4.2 Extend `src/store/app.store.ts` to trigger coin balance refresh
    - After successful `completeQuest`, call `useCoinStore.getState().refreshBalance(memberId)`
    - _Requirements: 7.2_

- [ ] 5. Implement UI components
  - [ ] 5.1 Create `src/components/shared/DifficultySelector.tsx`
  ...
  - [ ] 5.2 Create `src/components/layout/CoinBalance.tsx`
  ...
  - [ ] 5.3 Integrate `CoinBalance` into the navigation/top bar area
  ...
  - [ ] 5.4 Extend `ProposeTaskForm` with difficulty selection
  ...
  - [ ]* 5.5 Write unit tests for DifficultySelector and CoinBalance components
...
- [ ] 7. Implement Admin View page and components
  - [ ] 7.1 Create `src/components/auth/AdminGuard.tsx`
  ...
  - [ ] 7.2 Create `src/components/admin/CoinConfigPanel.tsx`
  ...
  - [ ] 7.3 Create `src/components/admin/ProjectList.tsx`
  ...
  - [ ] 7.4 Create `src/components/admin/ProjectDetail.tsx`
  ...
  - [ ] 7.5 Create `src/components/admin/AdminTaskForm.tsx`
