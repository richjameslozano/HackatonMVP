...
- [x] 1. Define types, config, and validation utilities
  - [x] 1.1 Add RewardItem and PurchaseRecord interfaces to types/index.ts
  ...
  - [x] 1.2 Extend TABLE_IDS in config.ts with rewardItems and purchases
    - Add `rewardItems` and `purchases` entries to the `TABLE_IDS` object
    - _Requirements: 7.3_

  - [x] 1.3 Implement reward item validation functions in utils/validation.ts
  ...
  - [x]* 1.4 Write property test for reward item field validation (Property 7)
  ...
  - [x] 1.5 Add description truncation utility in utils/formatting.ts
  ...
  - [x]* 1.6 Write property test for description truncation (Property 3)
  ...
  - [x] 1.7 Add purchasability classification helper in utils/store-helpers.ts
  ...
  - [x]* 1.8 Write property test for purchasability classification (Property 2)
...
- [x] 2. Implement store.service.ts
  - [x] 2.1 Implement getSpendableBalance function
  ...
  - [x]* 2.2 Write property test for spendable balance calculation (Property 1)
  ...
  - [x] 2.3 Implement getActiveRewardItems and getAllRewardItems functions
  ...
  - [x]* 2.4 Write property test for active items filtering (Property 8)
  ...
  - [x]* 2.5 Write property test for items sorted by cost ascending (Property 4)
  ...
  - [x] 2.6 Implement processPurchase function
  ...
  - [x]* 2.7 Write property test for purchase record correctness (Property 5)
  ...
  - [x] 2.8 Implement getPurchaseHistory function
  ...
  - [x]* 2.9 Write property test for purchase history sorted descending (Property 6)
  ...
  - [x] 2.10 Implement createRewardItem, updateRewardItem, deactivateRewardItem functions
...
- [x] 4. Implement reward.store.ts and update coin.store.ts
  - [x] 4.1 Create useRewardStore Zustand store in src/store/reward.store.ts
  ...
  - [x] 4.2 Update useCoinStore to use getSpendableBalance
  ...
  - [x]* 4.3 Write unit tests for reward.store.ts
...
- [x] 5. Implement store UI components
  - [x] 5.1 Create RewardItemCard component in src/components/store/RewardItemCard.tsx
  ...
  - [x] 5.2 Create PurchaseConfirmDialog component in src/components/store/PurchaseConfirmDialog.tsx
  ...
  - [x] 5.3 Create PurchaseHistory component in src/components/store/PurchaseHistory.tsx
  ...
  - [x] 5.4 Create StorePage in src/pages/StorePage.tsx
  ...
  - [x]* 5.5 Write unit tests for store UI components
...
- [x] 6. Implement admin reward management
  - [x] 6.1 Create RewardItemForm component in src/components/admin/RewardItemForm.tsx
  ...
  - [x] 6.2 Create RewardAdminPanel component in src/components/admin/RewardAdminPanel.tsx
  ...
  - [x]* 6.3 Write unit tests for admin components
